...
bool testA64Assembler(const TestSettings& settings) noexcept {
  ...
  AssemblerTester<Assembler> tester(Environment::kArchAArch64, settings);
  ...
  TEST_INSTRUCTION("81468252", mov(w1, 0x1234));
  TEST_INSTRUCTION("8146C2D2", mov(x1, 0x123400000000));
